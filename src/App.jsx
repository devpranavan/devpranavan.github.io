    ...
    <section className="pt-40 pb-24 md:pt-60 md:pb-40 px-6 max-w-5xl mx-auto grid md:grid-cols-[1.5fr_1fr] gap-12 items-center overflow-hidden">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-dark/60 max-w-lg mb-10 leading-relaxed">
          I build responsive apps and care about clean code, user experience,
          and Machine Learning & Robotics. Who thrives at the intersection of
          code and creativity.
        </p>
        ...
        <div className="flex flex-wrap gap-4 mb-12">
          <a
            href="#work"
            className="px-8 py-4 bg-accent text-white font-bold rounded-none flex items-center gap-2"
          >
            View Projects <ArrowRight size={18} />
          </a>
          <a
            href="#"
            className="px-8 py-4 border-2 border-dark text-dark font-bold rounded-none"
          >
            Resume
          </a>
        </div>
        ...
        <div className="flex gap-6 mt-8">
          <SocialIcon
            icon={<Github size={22} />}
            href="https://github.com/devpranavan"
          />
          <SocialIcon
            icon={<Twitter size={22} />}
            href="https://x.com/devpranavan"
          />
          <SocialIcon
            icon={<Linkedin size={22} />}
            href="https://www.linkedin.com/in/pranavandev/"
          />
          <SocialIcon
            icon={<Mail size={22} />}
            href="mailto:pranavan.dev@gmail.com"
          />
        </div>
      </motion.div>
...
const About = () => {
  return (
    <section
      id="about"
      className="py-24 md:py-40 px-6 max-w-5xl mx-auto border-t border-gray-100"
    >
      <Label index="01" text="ABOUT" />
      <h2 className="text-3xl md:text-5xl font-syne font-bold mb-16">
        Who I Am
      </h2>
      <div className="grid md:grid-cols-2 gap-12 md:gap-24">
        ...
        >
          <p className="text-xl md:text-2xl text-dark/80 leading-relaxed font-light">
            I am a Software Engineering undergraduate and currently serving as a
            Software Intern at{" "}
            <span className="text-accent font-medium title">MyDynamica</span>, a
            dynamic university startup. My journey in tech is driven by a
        ...
        >
          <p className="text-lg text-dark/60 leading-relaxed">
            As a React + PHP/Laravel developer, I specialize in building robust
            backend systems and intuitive frontend experiences. I'm constantly
            exploring modern UI design trends and automation to streamline
            workflows, while nurturing my interest in Machine Learning and
            Robotics.
          </p>
        </motion.div>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {categories.map((cat, idx) => (
          ...
          >
            ...
            <h3 className="text-xl font-syne font-bold mb-6 uppercase tracking-tight">
              {cat.title}
            </h3>
            <ul className="space-y-3">
              {cat.skills.map((s) => (
                <li
                  key={s}
                  className="text-dark/60 text-sm flex items-center gap-2"
                >
        ...
        {jobs.map((job, idx) => (
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
              <div>
                <h3 className="text-2xl font-syne font-bold text-dark">
                  {job.company}
                </h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex gap-6 items-center">
            <div className="bg-accent/[0.02] p-4">
              ...
              <span>
                <img src={EduLogo} width={125} height={125}></img>
              </span>
            </div>
            <div>
              ...
              <p className="text-dark/60">
                B.Sc.Honours in Software Engineering (Undergraduate)
              </p>
            </div>
          </div>
...
const Footer = () => {
  return (
    <section
      id="contact"
      className="pt-24 pb-12 px-6 max-w-5xl mx-auto border-t border-dark"
    >
      <div className="py-24 space-y-12">
        ...
        <p className="text-xl md:text-2xl text-dark/40 max-w-2xl font-light">
          I'm open to collaborations, freelance projects, and internships. Feel
          free to reach out.
        </p>
        <div className="flex gap-8 md:gap-12 flex-wrap">
          <ContactLink
            label="Email"
            value="pranavan.dev@gmail.com"
            className="bg-teal-400 text-black px-6 py-3 rounded-lg font-semibold"
            href="mailto:pranavan.dev@gmail.com"
          />
          <ContactLink
            label="LinkedIn"
            value="Pranavan Sanmugananthan"
            href="https://www.linkedin.com/in/pranavandev/"
          />
          <ContactLink
            label="GitHub"
...
const Label = ({ index, text }) => (
  <div className="flex items-center gap-4 mb-8">
    <span className="text-xs font-bold text-accent font-syne tracking-widest">
      {index} /
    </span>
    <span className="text-xs font-bold text-dark/40 font-syne tracking-widest uppercase">
      {text}
    </span>
  </div>
);
